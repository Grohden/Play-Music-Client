...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_System_UserProfile.d.js)'))) {
    module.exports = require('./NodeRT_Windows_System_UserProfile.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.System', 'Windows.Storage', 'Windows.Globalization', 'System.Collections.Generic', 'Windows.Storage.Streams', 'Windows.Foundation'];
